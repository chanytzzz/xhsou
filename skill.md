...
**实际案例**：
- **始祖鸟趋势分析**：识别出"粉色系"内容平均互动率1:0.1，远高于中性色系1:0.06；"户外穿搭"场景内容收藏率达52%，显著高于纯产品展示的28%
- **ZARA趋势分析**：发现"平替大牌"内容平均互动率1:0.12（如"Celine平替"2344赞），是常规新品的2.4倍；"通勤场景"内容收藏率达56%，用户更关注实用性而非品牌故事
